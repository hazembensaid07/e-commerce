    ...
    <Grid container justify="center" >
        ...
        <Grid item xs={1} md={4} ></Grid>
         ...
         <Grid item xs={12} md={12} ><Divider  /></Grid>
            ...
            <Grid item xs={12} md={12}><StyledTextField  value={birth_date.substring(0, 10)} onChange={handleChange('birth_date')} id="name" label="Birth Date" type="" variant="outlined" fullWidth/></Grid>
            ...
            <Grid item xs={6} md={6}>Update your profile picture : </Grid>
